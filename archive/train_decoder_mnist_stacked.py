...
MODEL_FILE = "models/model_mnist_stacked.pth"
...
for param in model.som.parameters():
    param.requires_grad = False
...
torch.save(decoder.state_dict(), "models/decoder_mnist_stacked.pth")
print("✅ Decoder saved to decoder.pth")
