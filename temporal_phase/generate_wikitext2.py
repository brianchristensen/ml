"""
Text Generation from Trained WikiText-2 Model (CHARACTER-LEVEL)

Usage:
    python generate_wikitext2.py
    python generate_wikitext2.py --checkpoint wikitext2_best.pt --prompt "The history of"
    python generate_wikitext2.py --prompt "In computer science," --temperature 0.9
"""
...
def interactive_generation(model, tokenizer, device='cuda'):
    ...
    print("=" * 80)
    print("Interactive Text Generation (WikiText-2)")
    print("=" * 80)
    print()
    print("Commands:")
...
def main():
    parser = argparse.ArgumentParser(description="Generate text from trained WikiText-2 model")
    parser.add_argument('--checkpoint', type=str, default='wikitext2_best.pt',
    ...
    if not Path(args.checkpoint).exists():
        ...
        print()
        print("Train a model first with: python train_wikitext2.py")
        return
